/**
 * Database seed for the NEET Smart Practice & Admission Assistance Platform.
 *
...
async function main() {
  ...
  await prisma.notification.create({
    data: {
      title: { en: 'Welcome to NEET Smart Practice!', ta: 'நீட் ஸ்மார்ட் பயிற்சிக்கு வரவேற்கிறோம்!' },
      message: {
