  ...
  return (
    <section className="rounded-2xl border border-white/10 bg-[#0b1b1e] p-6">
      ...
      <p className="mt-3 max-w-xl text-sm leading-6 text-slate-300">
        Full support ticketing is coming later. For Phase 1, use WhatsApp to reach the SIVORA partner team.
      </p>
      <div className="mt-6">
        <WhatsAppLink
          label="Chat with SIVORA on WhatsApp"
          message={`Hello SIVORA,\nI am contacting you from ${agency.name} and need partner support.`}
