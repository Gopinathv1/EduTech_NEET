  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
      <div>
        ...
        <p className="mt-1 text-sm text-textSecondary">Approved VV Overseas agency partners only.</p>
      </div>
...
function partnerErrorText(code?: string) {
  const errors: Record<string, string> = {
    ...
    accountInactive: 'This partner account is inactive. Contact VV Overseas.',
