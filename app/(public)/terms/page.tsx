    ...
    <Container className="py-14 sm:py-20">
      <div className="max-w-3xl">
        ...
        <div className="mt-6 space-y-4 text-sm leading-7 text-textSecondary">
          <p>
            SIVORA provides competitive-exam preparation tools including question practice, mock tests,
          ...
          <p>
            Educational content is provided for practice and revision. SIVORA does not guarantee exam
