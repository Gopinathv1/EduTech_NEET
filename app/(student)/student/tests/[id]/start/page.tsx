  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main id="main-content" className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
        <Link href={`/student/tests/${id}`} className="text-sm font-medium text-brand hover:text-brand-dark">
          ← {t('back')}
        </Link>
        ...
        {completed ? (
          <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6">
            <h2 className="text-lg font-semibold text-slate-900">{t('completedTitle')}</h2>
            <p className="mt-2 text-sm text-slate-600">{t('completedNote')}</p>
            <Link
          ...
          <>
            ...
            <dl className="mt-6 grid grid-cols-2 gap-4">
              <div className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4">
                ...
                <div>
                  <dt className="text-xs font-medium text-slate-500">{t('durationLabel')}</dt>
              ...
              <div className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4">
                ...
                <div>
                  <dt className="text-xs font-medium text-slate-500">{t('questionsLabel')}</dt>
                  <dd className="text-sm font-bold text-slate-900">{test.totalQuestions}</dd>
                </div>
              </div>
            </dl>

            <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-5">
              <h2 className="text-sm font-semibold text-slate-900">{t('marking')}</h2>
              ...
              <h2 className="mt-5 text-sm font-semibold text-slate-900">{t('navigation')}</h2>
              <p className="mt-2 text-sm text-slate-600">{t('navHelp')}</p>
