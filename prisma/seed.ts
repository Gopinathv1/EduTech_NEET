/**
 * Database seed for the SIVORA UP↑RISING competitive-exam preparation platform.
 *
...
async function main() {
  ...
  await prisma.notification.create({
    data: {
      title: { en: 'Welcome to SIVORA UP↑RISING!', ta: 'SIVORA UP↑RISING-க்கு வரவேற்கிறோம்!' },
      message: {
