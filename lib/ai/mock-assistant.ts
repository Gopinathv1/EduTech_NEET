...
const KNOWLEDGE_BASE: KnowledgeEntry[] = [
  {
    ...
    answer: {
      en: 'VV Overseas supports NEET preparation through Question Bank practice, chapter-wise practice, previous-year practice, full-length mock tests, answers, explanations and performance analytics. NEET is the active exam focus today.',
      ta: 'VV Overseas NEET தயாரிப்புக்கு Question Bank, chapter-wise practice, previous-year practice, முழு நீள mock tests, பதில்கள், விளக்கங்கள் மற்றும் performance analytics வழங்குகிறது. இப்போது செயலில் உள்ள தேர்வு NEET.',
      hi: 'VV Overseas NEET तैयारी के लिए Question Bank practice, chapter-wise practice, previous-year practice, full-length mock tests, answers, explanations और performance analytics देता है. अभी सक्रिय परीक्षा NEET है.',
    },
  },
  {
    id: 'mock-tests',
  ...
  },
  {
    ...
    answer: {
      en: 'VV Overseas provides education and admission guidance for medical education, MBBS Abroad, country and university selection, course selection, application guidance and counselling. For India, the site positions the service as MBBS counselling and guidance only, so final choices should be verified with the counselling team.',
      ta: 'VV Overseas medical education, MBBS Abroad, country and university selection, course selection, application guidance மற்றும் counselling-க்கு வழிகாட்டுகிறது. India-க்கு இது MBBS counselling and guidance ஆக மட்டுமே குறிப்பிடப்படுகிறது; இறுதி முடிவுகளை counselling team உடன் verify செய்ய வேண்டும்.',
      hi: 'VV Overseas medical education, MBBS Abroad, country and university selection, course selection, application guidance और counselling में मार्गदर्शन देता है. India के लिए service केवल MBBS counselling and guidance है, इसलिए final options counselling team से verify करने चाहिए.',
    },
  },
  {
    id: 'partners',
    ...
    answer: {
      en: 'VV Overseas has a Partner With Us pathway for schools, colleges, coaching centres, education consultants and overseas admission partners. Use the partner page or WhatsApp to speak with the partner team.',
      ta: 'VV Overseas schools, colleges, coaching centres, education consultants மற்றும் overseas admission partners-க்கு Partner With Us வழி வைத்துள்ளது. Partner page அல்லது WhatsApp மூலம் partner team-ஐ தொடர்பு கொள்ளலாம்.',
      hi: 'VV Overseas schools, colleges, coaching centres, education consultants और overseas admission partners के लिए Partner With Us pathway देता है. Partner page या WhatsApp से partner team से बात कर सकते हैं.',
    },
  },
  {
    id: 'auth',
...
const WELCOME: Record<SupportedLocale, string> = {
  en: "Hi! I'm Ask VV AI. I can help you with NEET preparation, admissions, mock tests, counselling and VV Overseas services. What would you like to know?",
  ta: 'வணக்கம்! நான் Ask VV AI. NEET தயாரிப்பு, சேர்க்கை வழிகாட்டுதல், Mock Tests, Counselling மற்றும் VV Overseas சேவைகள் குறித்து உங்களுக்கு உதவ முடியும். என்ன தெரிந்து கொள்ள விரும்புகிறீர்கள்?',
  hi: 'नमस्ते! मैं Ask VV AI हूं. मैं NEET तैयारी, एडमिशन, मॉक टेस्ट, काउंसलिंग और VV Overseas सेवाओं के बारे में आपकी मदद कर सकता हूं. आप क्या जानना चाहते हैं?',
};

const FALLBACK: Record<SupportedLocale, string> = {
  en: 'I do not have enough verified VV Overseas information to answer that confidently. Please talk to our team for current, confirmed guidance.',
  ta: 'அதற்கு நம்பிக்கையுடன் பதில் அளிக்க போதுமான verified VV Overseas தகவல் இல்லை. தற்போதைய உறுதியான வழிகாட்டலுக்கு எங்கள் team-ஐ தொடர்பு கொள்ளுங்கள்.',
  hi: 'इसका भरोसेमंद जवाब देने के लिए मेरे पास पर्याप्त verified VV Overseas जानकारी नहीं है. Current और confirmed guidance के लिए हमारी team से बात करें.',
};
