...
export default function PeacockQuillArtwork({ className = '' }: { className?: string }) {
  return (
    <div className={`pointer-events-none absolute ${className}`} aria-hidden="true">
      <div className="absolute inset-0 rounded-full bg-[radial-gradient(circle,rgba(15,143,125,0.24),transparent_58%)] blur-3xl" />
      <svg viewBox="0 0 760 560" className="absolute inset-0 h-full w-full" fill="none">
        ...
        <path d="M411 420c26 22 76 26 126 6" stroke="rgba(212,165,58,0.38)" strokeWidth="3" strokeLinecap="round" />
